let globalSettings = {
    ...
    copyright: {
        ...
        dates: '2004-2022',
        company: '葡萄软件',
        website: 'https://www.putao282.com'
    }
}
...
if (import.meta.env.VITE_APP_MODE === 'example' || import.meta.env.MODE === 'development') {
    ...
    globalSettings.menu.menuStyle = 'card'
    globalSettings.topbar.enableSidebarCollapse = true
    globalSettings.topbar.enableNotification = false
    globalSettings.topbar.enableI18n = false
    globalSettings.topbar.enableFullscreen = false
}
