        ...
        <div id='login-box'>
            ...
            <el-form v-show="formType == 'login'" ref='loginFormRef' :model='loginForm' :rules='loginRules' class='login-form' autocomplete='on' label-position='left'>
                        ...
                        <el-input ref='password' v-model='loginForm.password' :type='passwordType' :placeholder="t('app.password')" tabindex='2' autocomplete='on' @keyup.enter='handleLogin'>
                            ...
                            <template #suffix>
                                <el-icon @click='showPassword'>
                                    <i-ri-eye-close-line v-show="passwordType === 'password'" />
                                    <i-ri-eye-line v-show="passwordType !== 'password'" />
                                </el-icon>
                            </template>
                        </el-input>
                    </el-form-item>
                ...
                <div class='flex-bar'>
                    ...
                    <el-button text type='primary' @click="formType = 'reset'">忘记密码</el-button>
                </div>
                ...
                <div style='margin-top: 20px; margin-bottom: -10px; color: #666; font-size: 14px; text-align: center; font-weight: bold;'>
                    ...
                    <el-button type='danger' size='small' plain @click="testAccount('putao520')">putao520</el-button>
                </div>
            </el-form>
            <el-form v-show="formType == 'reset'" ref='resetFormRef' :model='resetForm' :rules='resetRules' class='login-form' auto-complete='on' label-position='left'>
                ...
                <el-row :gutter='15' style='padding-top: 20px;'>
                    <el-col :md='6'>
                        <el-button size='large' style='width: 100%;' @click="formType = 'login'">{{ t('app.goLogin')
                            }}
                        </el-button>
                    </el-col>
                    <el-col :md='18'>
                        <el-button :loading='loading' type='primary' size='large' style='width: 100%;' @click.prevent='handleFind'>
                            {{ t('app.check') }}
                        </el-button>
                    </el-col>
                </el-row>
...
function testAccount (account) {
    ...
    loginForm.value.password = '123123'
    handleLogin()
}
</script>
