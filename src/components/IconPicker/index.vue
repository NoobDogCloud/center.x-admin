<template>
    ...
    <el-dialog v-model="dialogVisible" width="600px" :show-close="true">
...
.icon-picker-dialog-body {
    ...
    .el-tabs {
        ...
        :deep(.el-tabs__nav-next) {
            background-image: linear-gradient(to right, transparent, #e4e7ed);
        }
        :deep(.el-tabs__header .el-tabs__nav) {
            .el-tabs__active-bar {
                ...
                background-image: linear-gradient(to right, transparent, #e1f0ff);
